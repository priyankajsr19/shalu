            ...
            <div id="tab-container" class="tab-container">
                ...
                <div id="tabs2" class='etab_content' style="height:300px;">
                    <ul>
                        ...
                        {/if}
                        {if isset($product->handbag_occasion) && $product->handbag_occasion != ''}
                            <li>
                                <span style="font-weight:bold;display:inline-block;width:90px;">Occasion:</span>
                                <span style="padding:0 10px;">{$product->handbag_occasion|escape:'htmlall':'UTF-8'}</span>
                            </li>
                        {/if}
                        {if isset($product->handbag_style) && $product->handbag_style}
                            <li>
                                <span style="font-weight:bold;display:inline-block;width:90px;">Style:</span>
                                <span style="padding:0 10px;">{$product->handbag_style|escape:'htmlall':'UTF-8'}</span>
                            </li>
                        {/if}
                        {if isset($product->handbag_material) && $product->handbag_material}
                            <li>
                                <span style="font-weight:bold;display:inline-block;width:90px;">Material:</span>
                                <span style="padding:0 10px;">{$product->handbag_material|escape:'htmlall':'UTF-8'}</span>
                            </li>
                        {/if}
