	...
	<div style="float:left;margin:10px;border:1px dashed #cacaca;width:960px;">
		...
		<form action="measurement.php" method="post" id="measurement_form" style="padding:10px;">
			...
			<tr>				
				...
				<td width="30%" align="left" class="measurement_middle">Waist</td>
			...
			<tr>				
				...
				<td width="20%" align="left" class="measurement_middle">Length</td>
			...
			<tr>				
				...
				<td width="20%" align="left" class="measurement_middle">Knee Length</td>
				...
				<td width="10%" align="center" class="measurement_middle">22.5</td>
				<td width="10%" align="center" class="measurement_middle">23</td>
				{if $cookie->isLogged()}<td width="10%" align="center" style="padding-top:5px;" class="measurement_middle">
			...
			<tr>				
				...
				<td width="20%" align="left" class="measurement_middle">Knee Loose</td>
				<td width="10%" align="center" class="measurement_middle">17</td>
				<td width="10%" align="center" class="measurement_middle">18</td>
			...
			<tr>				
				...
				<td width="20%" align="left" class="measurement_middle">Thigh</td>
				<td width="10%" align="center" class="measurement_middle">22</td>
				<td width="10%" align="center" class="measurement_middle">24</td>
				<td width="10%" align="center" class="measurement_middle">26</td>
				<td width="10%" align="center" class="measurement_middle">28</td>
				<td width="10%" align="center" class="measurement_middle">30</td>
				<td width="10%" align="center" class="measurement_middle">32</td>
				{if $cookie->isLogged()}<td width="10%" align="center" style="padding-top:5px;" class="measurement_middle">
			...
			<tr>				
				...
				<td width="20%" align="left" class="measurement_middle">Ankle Loose</td>
				<td width="10%" align="center" class="measurement_middle">9.5</td>
				<td width="10%" align="center" class="measurement_middle">10</td>
				<td width="10%" align="center" class="measurement_middle">10</td>
				<td width="10%" align="center" class="measurement_middle">10.5</td>
				<td width="10%" align="center" class="measurement_middle">10.5</td>
		...
		<td colspan="7" style="text-align:left">*All Measurements in Inches</td>
			...
			<p class="submit" style="clear:both;text-align:center">
				<input type="hidden" name="type_measurement" value="4"/>
...
$('input:radio[name=mntSize]').click(function(){
	...
	else
	{
		...
		$("#measurement_form").validate({
			...
			meta: "validate",
			groups: {
			    measurements: "name_measurement A B C D E F"
			  },
...
$('#SubmitMeasurement').click(function(e){
		...
		$.ajax(
				{
					...
					success: function(result){
						if(result.status == 'succeeded')
						{
							...
							if(!edit)
							{
    							$('#salwar_measurement_id').append('<option value='+result.id_measurement+'>'+result.name+'</option>');
    							$('#salwar_measurement_id').val(result.id_measurement);
    							$('#salwar_measurement_id').show();
	...
	{
		$('#measurement_form').fadeOut();
		$('#salwar_measurement_id').val($('input:radio[name=mntSize]:checked').val());
		$.fancybox.close();
	}
});
{/literal}
