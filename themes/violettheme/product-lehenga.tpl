                    ...
                    <form id="buy_block" {if $PS_CATALOG_MODE AND !isset($groups) AND $product->quantity > 0}class="hidden"{/if} action="{$link->getPageLink('cart.php')}" method="post" style="float:left">
                        ...
                        <p class="hidden">
                            ...
                            {if $product->is_customizable}
                                ...
                                {if $as_shown|default:false neq true}
                                            ...
                                            <p style="text-align:left;padding:9px 0">
                                                ...
                                                <select name="{$groupName}" id="group_{$id_attribute_group|intval}" onchange="javascript:findCombination();{if $colors|@count > 0}$('#wrapResetImages').show('slow');{/if};" style="padding:0;width:100px;">
                                                    {foreach from=$group.attributes key=id_attribute item=group_attribute}
                                                        <option value="{$id_attribute|intval}"{if (isset($smarty.get.$groupName) && $smarty.get.$groupName|intval == $id_attribute) || $group.default == $id_attribute} selected="selected"{/if} title="{$group_attribute|escape:'htmlall':'UTF-8'}">Bust: {$group_attribute|escape:'htmlall':'UTF-8'}″</option>
                                                    {/foreach}
                                                </select>
						{if isset($sizechart) &&  !empty($sizechart)}
                            ...
                            {if $product->is_customizable}
                                <div class="custom_group" style="border-top:1px dashed #cacaca;border-bottom:1px dashed #cacaca;">
                                    ...
                                    {assign var=cust_display value='display:block;'}
				                    {if $as_shown|default:true neq true}
                                        {assign var="checked" value=""}
                                        {assign var="cust_display" value="display:none"}
                                    ...
                                    {/if}
                                    <p style="margin-bottom:3px;">
                                        <input type="radio" name="lc-customization-option" id="sc-pre-stitched-lc" value="2" {$checked}/>
                                        <label for="sc-pre-stitched-lc">Customize to your size <span style="padding:0 15px;color:#E08323">+ {convertAndShow price=25}</span></label>
                                    </p>
                                    <div id="lc-customizations" style="{$cust_display}">
                                        ...
                                        <div id="blouse-style-select" style="padding: 5px 20px 5px 0px;width:150px;display:inline-block;border-right:1px solid #cacaca">
                                            ...
                                            <div style="width:75px;display:inline-block">
                                                {if $as_shown|default:false neq true}
                                                    <img id="blouse-style-img" src="{$img_ps_dir}styles/1-small.png" height="60" width="75" style="display:block"/>
                                                    ...
                                                    <a id="change-blouse-style" class="fancybox.ajax" style="font-size:12px;display:block;width:100%;text-align:center;line-height:13px;color:#75B1DC;" href="{$base_dir}modals.php?&modal=1&bs=1&lehenga=1">More Styles</a>
                                                {else}
                                                    <img id="blouse-style-img" src="{$img_ps_dir}styles/0-small.png" height="80" style="display:block"/>
                                                {/if}
                                        ...
                                        <div id="choli-measure-select" style="padding: 5px 0px 5px 20px;width:270px;display:inline-block;vertical-align:top;">
                                            ...
                                            <div style="width:165px;display:inline-block">
                                                <select id="blouse_measurement_id" name="c_measurement_id" style="{if !isset($measurement_info)}display:none{else}display:inline{/if};width:150px;padding:0;">
                                                    <option value="0" selected>Select a measurement</option>
                                                    {if isset($measurement_info)}
                                                        {foreach from=$measurement_info item=measurement}
                                        ...
                                        {if !isset($measurement_info)}
                                            <span id="no_measurement_txt" style="{if isset($measurement_info)}display:none{/if}">No saved measurements.</span>
                                        {/if}
                                        <a id="create_choli_measurement" class="measure_link span_link fancybox.ajax" style="color:#75B1DC;display:block" href="{$base_dir}measurement.php?&modal=1&m=1&type=1">size chart</a>
                                    </div>
                                </div>
                                ...
                                <div id="skirt-style-select" style="padding: 5px 20px 5px 0px;width:150px;display:inline-block;border-right:1px solid #cacaca">
                                    ...
                                    <div style="width:70px;display:inline-block;text-align:center">
                                        <img id="inskirt-style-img" src="{$img_ps_dir}styles/0-small.png" height="80"/>
                                        {if $as_shown|default:false neq true}
                                            <span id="inskirt-style-name" style="font-family:Abel;font-size:14px;display:block;width:100%;line-height:1em">As Shown</span>
                                            <a id="change-inskirt-style" class="fancybox.ajax" style="font-size:12px;display:block;width:100%;text-align:center;line-height:13px;color:#75B1DC;" href="{$base_dir}modals.php?&modal=1&iss=1&lehenga=1">More Styles</a>
                                        {/if}
                                    </div>
                                </div>
                                <div id="lehenga-measure-select" style="padding: 5px 0px 5px 20px;width:270px;display:inline-block;vertical-align:top;">
                                    <div style="display:inline-block">
                                        <span style="font-family:Abel;font-size:15px;display:inline-block;width:100px;height:60px;vertical-align:top;padding:0px 0px;">2. Measurement:</span>
                                        <div style="width:165px;display:inline-block">
                                            <select id="skirt_measurement_id" name="l_measurement_id" style="{if !isset($skirt_measurement_info)}display:none{else}display:inline{/if};width:150px;padding:0;">
                                                <option value="0" selected>Select a measurement</option>
                                                {if isset($skirt_measurement_info)}
                                                    {foreach from=$skirt_measurement_info item=measurement}
                                                        <option value="{$measurement.id_measurement}">
                                                            {if isset($measurement.name_measurement)}
                                                            {$measurement.name_measurement}{if $measurement.is_std == 1}″{/if}
                                                        {else}
                                    ...
                                    {if !isset($skirt_measurement_info)}
                                        <span id="no_measurement_txt" style="{if isset($skirt_measurement_info)}display:none{/if}">No saved measurements.</span>
                                    {/if}
                                    <a id="create_skirt_measurement" class="measure_link span_link fancybox.ajax" style="color:#75B1DC;display:block" href="{$base_dir}measurement.php?&modal=1&m=1&type=2">size chart</a>
                                </div>
                            </div>
                        </div>
                        {include file="$tpl_dir./customization_customer_height.tpl"}
                    </div>
        ...
        <div id="more_info_block">
            ...
            <div id="tab-container" class="tab-container" style="height:300px;">
                ...
                <div id="tabs1" class='etab_content' style="height:300px;overflow:auto;-ms-overflow-x: hidden;overflow-x: hidden;">
                    ...
                    {if isset($bollywood) && !empty($bollywood)}
