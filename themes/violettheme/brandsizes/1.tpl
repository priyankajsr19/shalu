<div style="float:left;margin:10px;border:1px dashed #cacaca;width:560px;">
	<div style="border-bottom:1px dashed #cacaca">
		...
		<tr style="background:#DFDFDF">				
			...
			<td width="20%" align="right" style="border-top: 1px solid #505050;" class="measurement_middle">BODY BUST SIZE (inches): </td>
		...
		<tr>				
			...
			<td width="20%" align="left" class="measurement_middle">Garment Bust</td>
