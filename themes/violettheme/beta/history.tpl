...
<div style="width:970px;">
	<div class="vtab-bar">
		<ul id="my_account_links">
			...
			<li class="selected"><div class="vtab-bar-link"><a href="{$base_dir_ssl}history.php" title="{l s='Orders'}">{l s='Orders'}</a></li>
			{if $returnAllowed}
			...
			{if $voucherAllowed}
				<li><a href="{$base_dir_ssl}discount.php" title="{l s='Vouchers'}">{l s='My vouchers'}</a></div></li>
			{/if}
	...
	<div class="vtab-content">
		...
		<div id="h-bar" style="width:600px;border-top:1px dotted #cacaca;height:2px;clear:both;"></div>
