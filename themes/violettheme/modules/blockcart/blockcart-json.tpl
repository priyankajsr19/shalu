...
{assign var='productAttributeId' value=$product.id_product_attribute}
	{ldelim}
		...
		"name":          "{$product.name|html_entity_decode:2:'UTF-8'|escape|truncate:100:'...':true}",
...
"totalDiscounts": "{$totalDiscounts|html_entity_decode:2:'UTF-8'}",
"productTotal": "{$product_total|html_entity_decode:2:'UTF-8'}",
"only_products": "{$ajax_products_total|html_entity_decode:2:'UTF-8'}",
