...
{
	$('#image-block li.visible').hide();
    $('#bigpic_'+domAAroundImgThumb.attr('data-imgid')).fadeIn('slow').addClass('visible');
    
    console.log('bigpic_'+domAAroundImgThumb.attr('data-imgid'));
...
$(document).ready(function()
{
	...
	$('.thickbox').attr('rel', 'gallery').fancybox({
		fitToView : true,
		margin:0,
		padding:0,
		nextEffect:'fade',
