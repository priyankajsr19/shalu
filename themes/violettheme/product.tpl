...
{if $errors|@count == 0}
    <script type="text/javascript">
        ...
        <div itemscope itemtype="http://schema.org/Product" id="primary_block" class="clearfix" >
            ...
            <div id="pb-left-column" style="position:relative">
                ...
                {if ($product->show_price AND !isset($restricted_country_mode)) OR isset($groups) OR $product->reference OR (isset($HOOK_PRODUCT_ACTIONS) && $HOOK_PRODUCT_ACTIONS)}
                    <!-- add to cart form-->
                    <form id="buy_block" {if $PS_CATALOG_MODE AND !isset($groups) AND $product->quantity > 0}class="hidden"{/if} action="{$link->getPageLink('cart.php')}" method="post" style="float:left" autocomplete="off">
                        ...
                        <p class="hidden">
                            ...
                            <input type="hidden" name="id_blouse_style" id="id_blouse_style" value="{$blouse_style.id_style}" />
			...
			{include file="$tpl_dir./product_page_social_love.tpl"}
                        ...
                        *}
                        <div id="saree-customizations" style="margin-top:10px;border-top:1px dashed #cacaca;padding:5px 0;">
                            ...
                            <div class="custom_group" style="border-bottom:1px dashed #cacaca;border-top:none">
                                <p style="margin-bottom:3px;">
                                    ...
                                    <label for="sc-pre-stitched-saree">Pre-Stitched saree with inskirt <a style="color:#75B1DC;" class="span_link" target="_blank" href="/pre-stitched-saree.php">(whats this?)</a><span style="padding:0 15px;color:#E08323">+ {convertAndShow price=15}</span></label>

                                </p>
                                {*<div id="inskirt-customizations-pss" style="display:none">
                                ...
                                <img id="inskirt-style-img" src="{$img_ps_dir}styles/13-small.png" height="80"/>
                                <span id="inskirt-style-name" style="font-family:Abel;font-size:14px;display:block;width:100%;line-height:1em">A-Line</span>
                                <a id="change-inskirt-style" class="fancybox.ajax" style="font-size:12px;display:block;width:100%;text-align:center;line-height:13px;color:#75B1DC;" href="{$base_dir}modals.php?&modal=1&iss=1">More Styles</a>
                                </div>
                                </div>
                                ...
                                <select id="skirt_measurement_id" name="is_measurement_id" style="{if !isset($skirt_measurement_info)}display:none{else}display:inline{/if};width:150px;padding:0;">
                                ...
                                <p id="stitched-inskirt-options" style="margin-bottom:3px;">
                                    ...
                                    <label for="sc-stitched-inskirt">Stitched to measure inskirt (petticoat) <span style="padding:0 15px;color:#E08323">+ {convertAndShow price=9}</span></label>
                                </p>
                        ...
                        <p style="margin-bottom:3px;">
                            ...
                            <label for="sc-stitched-blouse">Stitched to measure blouse {if $blouse_style_count neq 1}<a style="color:#75B1DC;" class="span_link" target="_blank" href="/blouse-styles.php">(blouse styles)</a>{/if} <span style="padding:0 15px;color:#E08323">+ {convertAndShow price=16}</span></label>
                        </p>
                        <div id="blouse-customizations" style="display:none">
                            <div id="blouse-style-select" style="padding: 5px 20px 5px 0px;width:150px;display:inline-block;border-right:1px solid #cacaca">
                                ...
                                <div style="width:75px;display:inline-block">
                                    <img id="blouse-style-img" src="{$img_ps_dir}styles/{$blouse_style.style_image_small}" height="60" width="75" style="display:block"/>
                                    <span id="blouse-style-name" style="font-family:Abel;font-size:14px;display:block;width:100%;text-align:center;line-height:1em">{$blouse_style.style_name}</span>
                                    {if $blouse_style_count neq 1} 
                                        <a id="change-blouse-style" class="fancybox.ajax" style="font-size:12px;display:block;width:100%;text-align:center;line-height:13px;color:#75B1DC;" href="{$base_dir}modals.php?&modal=1&bs=1&id={$product->id}">More Styles</a>
                                    {/if}
                                </div>
                            </div>
                            <div id="blouse-measure-select" style="padding: 5px 0px 5px 20px;width:270px;display:inline-block;vertical-align:top;">
                                <span style="font-family:Abel;font-size:15px;display:inline-block;width:100px;height:60px;vertical-align:top;padding:0px 0px;">2. Measurement:</span>
                                <div style="width:165px;display:inline-block">
                                    <select id="blouse_measurement_id" name="b_measurement_id" style="{if !isset($measurement_info)}display:none{else}display:inline{/if};width:150px;padding:0;">
                                        <option value="0" selected>Select a measurement</option>
                            ...
                            {/if}
                            <a id="create_blouse_measurement" class="measure_link span_link fancybox.ajax" style="color:#75B1DC;display:block" href="{$base_dir}measurement.php?&modal=1&m=1&type=1">size chart</a>
                        </div>
                    </div>
                </div>
        ...
        <p style="border-bottom:1px dashed #cacaca;padding:5px 0;clear:both" id="fall_piko_wrap">
            <input type="checkbox" name="fall_piko" id="fall_piko" checked="checked" value="1"/>&nbsp;<label for="fall_piko">Standard fall and edging (piko) work</label><span style="padding:0 15px;color:#E08323">+ {convertAndShow price=2}</span>
        </p>
