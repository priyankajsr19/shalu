...
<div style="width:970px;">
	<div class="vtab-bar">
		<ul id="my_account_links">
			...
			{/if}
			<li class="selected"><div class="vtab-bar-link"><a href="{$base_dir_ssl}order-slip.php" title="{l s='Credit slips'}">{l s='Credit Slips'}</a></div></li>
			<li><div class="vtab-bar-link"><a href="{$base_dir_ssl}addresses.php" title="{l s='Addresses'}">{l s='Addresses'}</a></div></li>
