        ...
        {if isset($groups)}
            ...
            {if $colors|@count > 0}
                {if $product->id_color_default}
                    var id_color_default = {$product->id_color_default|intval};
                {/if}
            {/if}
        {/if}
    //]]>
    ...
    <div itemscope itemtype="http://schema.org/Product" id="primary_block" class="clearfix" >
        ...
        <div id="product-top">
                    ...
                    {if isset($images) && count($images) > 1}
                        <p class="align_center clear">
                            <span id="wrapResetImages" style="display: none;">
                                <img src="{$img_dir}icon/cancel_16x18.gif" alt="{l s='Cancel'}" width="16" height="18"/>
            ...
            <div id="pb-left-column" style="position:relative">
				...
				{if isset($kurta_style) && !empty($kurta_style)}
	                                <input type="hidden" name="id_kurta_style" id="id_kurta_style" value="{$kurta_style.id_style}" />
				...
				{/if}
				{if isset($salwar_style) && !empty($salwar_style)}
	                                <input type="hidden" name="id_salwar_style" id="id_salwar_style" value="{$salwar_style.id_style}" />
                                ...
                                <div class="custom_group" style="border-top:1px dashed #cacaca;border-bottom:1px dashed #cacaca;">
                                    ...
                                    <p style="margin-bottom:3px;">
                                        ...
                                        <label for="sc-pre-stitched-skd">
                                            ...
                                            {if ($kurta_style_count <=0) || ($salwar_style_count<=0)}
                                                <span style="padding:0 15px;color:#E08323">+ {convertAndShow price=5}</span>
                                            {else}  
                                                {if isset($is_anarkali) && $is_anarkali}
                                                    <span style="padding:0 15px;color:#E08323">+ {convertAndShow price=14}</span>
                                                {else}
                                                    <span style="padding:0 15px;color:#E08323">+ {convertAndShow price=9}</span>
                                                {/if}
                                            {/if}
                                        </label>
                                    </p>
                                        ...
                                        {if $kurta_style_count > 0}
                                            ...
                                            <div class="clearfix" style="padding:6px 0px 6px 10px">
                                                <span style="font-family:Abel;font-size:15px;display:block;">
                                                    {if isset($is_pakistani_rts) && !empty($is_pakistani_rts)}
                                                        {$incr}. Neckline and Kurta Cut is as shown in the product visual
                                                    {else}
                                                        {$incr}. Kurta Cut is as shown in the product visual
                                                    {/if}
                                                </span>
                                            </div>    
                                            {assign var=incr value=$incr+1}
                                            <div class="clearfix" style="padding:6px 0px 6px 0px">
                                                <div id="kurta-style-select" style="float:left;padding: 5px 20px 5px 0px;width:150px;display:inline-block;border-right:1px solid #cacaca">
                                                    <span style="font-family:Abel;font-size:15px;display:block;vertical-align:top;padding:0px 10px;">{$incr}. Top style:</span>
                                                    <div style="width:75px;display:inline-block;padding: 5px 0px 0px 20px;">
                                                        <img id="kurta-style-img" src="{$img_ps_dir}styles/{$kurta_style.style_image_small}" height="60" width="75" style="display:block"/>
                                                        <span id="kurta-style-name" style="font-family:Abel;font-size:14px;display:block;width:100%;text-align:center;line-height:1em">{$kurta_style.style_name}</span>
                                                        {if $kurta_style_count > 1}
                                                            <a id="change-kurta-style" class="fancybox.ajax" style="font-size:12px;display:block;width:100%;text-align:center;line-height:13px;color:#75B1DC;" href="{$base_dir}modals.php?&modal=1&id={$product->id}&sts=1">More Styles</a>
                                                        {/if}
                                                    </div>
                                                </div>
                                                <div id="kurta-measure-select" style="float:right;padding: 5px 20px 5px 20px;width:245px;display:inline-block;">
                                                    <span style="font-family:Abel;font-size:15px;display:block;width:150px;vertical-align:top;padding:0px 0px;">{$incr}. Kurta Measurement:</span>
                                        ...
                                        {if $salwar_style_count > 0}
                                            ...
                                            <div class="clearfix" style="padding:6px 0px 6px 0px">
                                                ...
                                                <div id="salwar-style-select" style="float:left;padding: 5px 20px 5px 0px;width:150px;display:inline-block;border-right:1px solid #cacaca">
                                                    <span style="font-family:Abel;font-size:15px;display:block;vertical-align:top;padding:0px 10px;">{$incr}. Bottom style:</span>
                                                    <div style="width:75px;display:inline-block;padding: 5px 0px 0px 20px;">
                                                        <img id="salwar-style-img" src="{$img_ps_dir}styles/{$salwar_style.style_image_small}" height="60" width="75" style="display:block"/>
                                                        <span id="salwar-style-name" style="font-family:Abel;font-size:14px;display:block;width:100%;text-align:center;line-height:1em">{$salwar_style.style_name}</span>
                                                        {if $salwar_style_count > 1}
                                                            <a id="change-salwar-style" class="fancybox.ajax" style="font-size:12px;display:block;width:100%;text-align:center;line-height:13px;color:#75B1DC;" href="{$base_dir}modals.php?&modal=1&id={$product->id}&sbs=1">More Styles</a>
                                                        {/if}
                                                    </div>
                                                </div>
                                                <div id="salwar-measure-select" style="float:right; padding: 5px 0px 5px 20px;width:265px;display:inline-block;vertical-align:top;">
                                                    <span style="font-family:Abel;font-size:15px;display:block;width:150px;vertical-align:top;padding:0px 0px;">{$incr}. Bottom Measurement:</span>
