                        ...
                        {foreach from=$groups key=id_attribute_group item=group}
                            {if $group.attributes|@count}
                                <p style="text-align:left;padding:9px 0">
                                    ...
                                    <select name="{$groupName}" id="group_{$id_attribute_group|intval}" onchange="javascript:findCombination();{if $colors|@count > 0}$('#wrapResetImages').show('slow');{/if};" style="padding:0;width:120px;">
                                        {foreach from=$group.attributes key=id_attribute item=group_attribute}
                                            <option value="{$id_attribute|intval}"{if (isset($smarty.get.$groupName) && $smarty.get.$groupName|intval == $id_attribute) || $group.default == $id_attribute} selected="selected"{/if} title="{$group_attribute|escape:'htmlall':'UTF-8'}">
                                                ...
                                                {elseif $is_wristwear}
                                                    Diameter: {$group_attribute|escape:'htmlall':'UTF-8'}″
                                                {else}
            ...
            <div id="tab-container" class="tab-container">
                ...
                <div id="tabs2" class='etab_content' style="height:300px;">
                    <ul>
                        ...
                        {/if}
                        {if isset($product->stone) && $product->stone != ''}
                            <li>
                                <span style="font-weight:bold;display:inline-block;width:90px;">Stone</span>
                                <span style="padding:0 10px;">{$product->stone|escape:'htmlall':'UTF-8'}</span>
                            </li>
                        {/if}
                        {if isset($product->plating) && $product->plating != ''}
                            <li>
                                <span style="font-weight:bold;display:inline-block;width:90px;">Plating</span>
                                <span style="padding:0 10px;">{$product->plating|escape:'htmlall':'UTF-8'}</span>
                            </li>
                        {/if}
                        {if isset($product->material) && $product->material != ''}
                            <li>
                                <span style="font-weight:bold;display:inline-block;width:90px;">Material</span>
                                <span style="padding:0 10px;">{$product->material|escape:'htmlall':'UTF-8'}</span>
                            </li>
                        {/if}
                        {if isset($product->dimensions) && $product->dimensions != ''}
                            <li>
                                ...
                                <span style="padding:0 10px;">{$product->dimensions|escape:'htmlall':'UTF-8'}</span>
                            </li>
                        {/if}
                        {if isset($product->look) && $product->look != ''}
                            <li>
                                <span style="font-weight:bold;display:inline-block;width:90px;">Look</span>
                                <span style="padding:0 10px;">{$product->look|escape:'htmlall':'UTF-8'}</span>
                            </li>
                        {/if}
                    </ul>
                </div>
