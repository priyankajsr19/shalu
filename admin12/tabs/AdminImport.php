	...
	public function __construct()
	{
		...
		switch ((int)(Tools::getValue('entity')))
		{
			...
			case $this->entities[$this->l('Products')]:
				...
				'is_exclusive' => array('label' => $this->l('Exclusive (0/1)')),
				'is_customizable' => array('label' => $this->l('RTS (0/1)')),
				'id_sizechart' => array('label' => $this->l('Sizechart ID')),
				'is_plussize' => array('label' => $this->l('PlusSize(0/1)')),
				'condition' => array('label' => $this->l('Condition')),
				'cashback_percentage' => array('label' => $this->l('Cashback %')));
	...
	*/
	...
	public function displayForm($isMainTab = true)
	{
		...
		if (sizeof($filesToImport))
		{
			...
			$defaultEntity = Tools::getValue('entity', 1);
