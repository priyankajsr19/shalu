...
class AdminManufacturers extends AdminTab
{
	...
	public function viewmanufacturer()
	{
		...
		echo '<br /><br />';
		echo '<h3>'.$this->l('Total products:').' '.sizeof($products).'</h3>[<a href="OMS.php?getManufacturerProducts=1&id_manufacturer='.$manufacturer->id.'"><span>download list</span></a>]';
		echo '<br /><br /><a href="OMS.php?getLastMonthSales=1&id_manufacturer='.$manufacturer->id.'"><span>download last month sales</span></a>';
