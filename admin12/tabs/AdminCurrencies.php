...
class AdminCurrencies extends AdminTab
{
	public function __construct()
	{
		...
		'active' => array('title' => $this->l('Enabled'), 'width' => 25, 'align' => 'center', 'active' => 'status', 'type' => 'bool', 'orderby' => false),
                'paypal_support' => array('title' => $this->l('Paypal Support'), 'width' => 25, 'align' => 'center', 'paypal_support' => 'status', 'type' => 'bool', 'orderby' => false));
			...
			<fieldset><legend><img src="../img/admin/money.gif" />'.$this->l('Currencies').'</legend>
				...
				<div class="margin-form">
					...
					<p>'.$this->l('Include a blank between sign and price, e.g.,').'<br />$1,240.15 -> $ 1,240.15</p>
                                ...
                                <label>'.$this->l('PayPal Support:').' </label>
				<div class="margin-form">
					<input type="radio" name="paypal_support" id="paypal_support_on" value="1" '.($this->getFieldValue($obj, 'paypal_support') ? 'checked="checked" ' : '').'/>
					<label class="t" for="paypal_support_on"> <img src="../img/admin/enabled.gif" alt="'.$this->l('Enabled').'" title="'.$this->l('Yes').'" /></label>
					<input type="radio" name="paypal_support" id="paypal_support_off" value="0" '.(!$this->getFieldValue($obj, 'paypal_support') ? 'checked="checked" ' : '').'/>
					<label class="t" for="paypal_support_off"> <img src="../img/admin/disabled.gif" alt="'.$this->l('Disabled').'" title="'.$this->l('No').'" /></label>
				</div>
