...
class CountryCore extends ObjectModel
{
	...
	protected   static $_isoToCountries = array();
	...
	public function getFields()
	{
		...
		$fields['alternate_name'] = $this->alternate_name;
		$fields['boost'] = $this->boost;
		return $fields;
	}
	...
	{
		if(array_key_exists($iso_code, self::$_isoToCountries))
			return self::$_isoToCountries[$iso_code];
		...
		self::$_isoToCountries[$iso_code] = $result['id_country'];
