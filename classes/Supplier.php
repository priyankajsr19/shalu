...
class SupplierCore extends ObjectModel
{
	...
	public		$active;
 	...
 	protected 	$fieldsRequired = array('name','code','id_location');
	...
	public function getFields()
	{
		...
		$fields['name'] = pSQL($this->name);
                ...
                $fields['address'] = pSQL($this->adress);
                $fields['contact_person'] = pSQL($this->contact_person);
	...
	*/
	...
	public function delete()
	{
        ...
        static public function getSupplierLocations() {
            $res = Db::getInstance()->ExecuteS('select * from '._DB_PREFIX_.'locations');
            return $res;
        }
}
