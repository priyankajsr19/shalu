...
class CurrencyCore extends ObjectModel
{
	...
	public		$active;
        ...
        /** @var int bool paypal_support */
        public          $paypal_support;
 	...
 	protected 	$fieldsValidate = array('name' => 'isGenericName', 'iso_code' => 'isLanguageIsoCode', 'iso_code_num' => 'isNumericIsoCode', 'blank' => 'isInt', 'sign' => 'isGenericName',
		'format' => 'isUnsignedId', 'decimals' => 'isBool', 'conversion_rate' => 'isFloat', 'deleted' => 'isBool', 'active' => 'isBool', 'paypal_support' => 'isBool');
	...
	public function getFields()
	{
		...
		$fields['active'] = (int)($this->active);
                $fields['paypal_support'] = (int)($this->paypal_support);
		return $fields;
	}
