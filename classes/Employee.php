...
class EmployeeCore extends ObjectModel
{
	...
	public 		$active = 1;
 	...
 	protected 	$fieldsValidate = array('lastname' => 'isName', 'firstname' => 'isName', 'email' => 'isEmail', 'id_lang' => 'isUnsignedInt', 
		'passwd' => 'isPasswdAdmin', 'active' => 'isBool', 'id_profile' => 'isInt', 'bo_color' => 'isColor', 'bo_theme' => 'isGenericName', 'bo_uimode' => 'isGenericName','id_location' => 'isName');
	...
	public	function getFields()
	{
		...
		$fields['bo_uimode'] = pSQL($this->bo_uimode);
                $fields['id_location'] = pSQL($this->id_location);
	...
	/**
	  ...
	  */
	public function getByEmail($email, $passwd = NULL, $fromApi = false)
	{
	...
	public function setWsPasswd($passwd)
	{
        ...
        public function generateToken($email) {
            ...
            $memcache->set($token, $email, false, 172800); //cache for 2 days
            return $token;
        }
