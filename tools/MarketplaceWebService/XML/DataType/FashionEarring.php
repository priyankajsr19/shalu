<?php
class MarketplaceWebService_XML_DataType_FashionEarring extends MarketplaceWebService_XML_DataType_Base {
    ...
    public function setVariationTheme($value) {
        if (!in_array($value, array('MetalType', 'Color', 'StyleName', 'Diameter','DisplayWeight'))) {
