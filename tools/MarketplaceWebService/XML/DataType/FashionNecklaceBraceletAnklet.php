<?php
class MarketplaceWebService_XML_DataType_FashionNecklaceBraceletAnklet extends MarketplaceWebService_XML_DataType_Base {
    ...
    public function setVariationTheme($value) {
        if (!in_array($value, array('Length','MetalType','Length-MetalType','Color','StyleName','Diameter','DisplayWeight'))) {
            throw new InvalidArgumentException("Invalid variation theme $value");
        }
    ...
    public function addMaterial($value) {
        if( empty($value) )
            throw new InvalidArgumentException("Material value cannot be empty");
	...
	public function setChainDescription($value) {
		return $this->set('ChainDescription',$value);
	}
    ...
    public function setDepartmentName($value) {
        if( empty($value) )
            throw new InvalidArgumentException("DepartmentName cannot be empty");
    ...
    public function setItemShape($value) {
        if( empty($value) )
            throw new InvalidArgumentException("ItemShape must not be empty");
    ...
    public function getXML($feed) {
        $main = $feed->createNode('FashionNecklaceBraceletAnklet');
		...
		$feed->addNode($main, $this, 'ChainDescription');
