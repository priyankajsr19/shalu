<?php /* Smarty version Smarty-3.0.7, created on 2015-05-25 14:01:30
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/indusdiva/themes/violettheme/order-address-billing.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4949528595562dde21c8be8-32357921%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7b1d99d4179f0c6721543ce6fa2ebf6a32a5c71e' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/indusdiva/themes/violettheme/order-address-billing.tpl',
      1 => 1431660623,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4949528595562dde21c8be8-32357921',
  'function' => 
  array (
  ),
...
" class="button" /><?php }?>
		...
		<?php if ((isset($_smarty_tpl->getVariable('addresses',null,true,false)->value)&&count($_smarty_tpl->getVariable('addresses')->value)>0)&&!(isset($_smarty_tpl->getVariable('errors',null,true,false)->value)&&$_smarty_tpl->getVariable('errors')->value)){?>
			<div id="add_button_wrapper" style="width:100%">
				<span class="prev_shipaddress_label" style="display:block;padding:5px 10px;font-size:15px;<?php if (isset($_smarty_tpl->getVariable('id_address',null,true,false)->value)&&$_smarty_tpl->getVariable('id_address')->value){?>display:none<?php }?>">Please choose a billing address or enter a new address.</span>
				<span class="prev_shipaddress_label" style="padding-left:10px;<?php if (isset($_smarty_tpl->getVariable('id_address',null,true,false)->value)&&$_smarty_tpl->getVariable('id_address')->value){?>display:none<?php }?>">This should be as it appears on you Credit Card statement.</span> 
...
" rel="<?php echo intval($_smarty_tpl->tpl_vars['address']->value['id_address']);?>
...
order.php?step=2&id_address=<?php echo intval($_smarty_tpl->tpl_vars['address']->value['id_address']);?>
