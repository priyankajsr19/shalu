<?php /* Smarty version Smarty-3.0.7, created on 2015-08-13 16:56:56
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/indusdiva2/themes/violettheme/product-jewelry.tpl" */ ?>
<?php /*%%SmartyHeaderCode:178225649355cc7f00e536d3-88054560%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'de2eba129899e3baa1191c061b1e2c430479d54e' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/indusdiva2/themes/violettheme/product-jewelry.tpl',
      1 => 1437833296,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '178225649355cc7f00e536d3-88054560',
  'function' => 
  array (
  ),
...
" onchange="javascript:findCombination();<?php if (count($_smarty_tpl->getVariable('colors')->value)>0){?>$('#wrapResetImages').show('slow');<?php }?>;" style="padding:0;width:120px;">
...
″
                                                <?php }elseif($_smarty_tpl->getVariable('is_wristwear')->value){?>
                                                    Diameter: <?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['group_attribute']->value,'htmlall','UTF-8');?>
″
                                                <?php }else{ ?>
        ...
        <div id="more_info_block">
            ...
            <div id="tab-container" class="tab-container">
                <ul class='etabs'>
                    ...
                    <li class='etab'><a href="#tabs3">Care</a></li>
                ...
                <div id="tabs1" class='etab_content' style="height:300px;overflow:auto;-ms-overflow-x: hidden;overflow-x: hidden;">
                    ...
                    <p>The jewelry piece (including the stones and plating) may look slightly darker or lighter because of the light and settings during photography and also the color settings and properties of various monitors.</p>
                </div>
                <div id="tabs2" class='etab_content' style="height:300px;">
                    <ul>
                        ...
                        <?php }?>
                        <?php if (isset($_smarty_tpl->getVariable('product',null,true,false)->value->stone)&&$_smarty_tpl->getVariable('product')->value->stone!=''){?>
                            <li>
                                <span style="font-weight:bold;display:inline-block;width:90px;">Stone</span>
                                <span style="padding:0 10px;"><?php echo smarty_modifier_escape($_smarty_tpl->getVariable('product')->value->stone,'htmlall','UTF-8');?>
</span>
                            </li>
                        <?php }?>
                        <?php if (isset($_smarty_tpl->getVariable('product',null,true,false)->value->plating)&&$_smarty_tpl->getVariable('product')->value->plating!=''){?>
                            <li>
                                <span style="font-weight:bold;display:inline-block;width:90px;">Plating</span>
                                <span style="padding:0 10px;"><?php echo smarty_modifier_escape($_smarty_tpl->getVariable('product')->value->plating,'htmlall','UTF-8');?>
</span>
                            </li>
                        <?php }?>
                        <?php if (isset($_smarty_tpl->getVariable('product',null,true,false)->value->material)&&$_smarty_tpl->getVariable('product')->value->material!=''){?>
                            <li>
                                <span style="font-weight:bold;display:inline-block;width:90px;">Material</span>
                                <span style="padding:0 10px;"><?php echo smarty_modifier_escape($_smarty_tpl->getVariable('product')->value->material,'htmlall','UTF-8');?>
</span>
                            </li>
                        <?php }?>
                        <?php if (isset($_smarty_tpl->getVariable('product',null,true,false)->value->dimensions)&&$_smarty_tpl->getVariable('product')->value->dimensions!=''){?>
                            <li>
                                <span style="font-weight:bold;display:inline-block;width:90px;">Dimensions</span>
                                <span style="padding:0 10px;"><?php echo smarty_modifier_escape($_smarty_tpl->getVariable('product')->value->dimensions,'htmlall','UTF-8');?>
</span>
                            </li>
                        <?php }?>
                        <?php if (isset($_smarty_tpl->getVariable('product',null,true,false)->value->look)&&$_smarty_tpl->getVariable('product')->value->look!=''){?>
                            <li>
                                <span style="font-weight:bold;display:inline-block;width:90px;">Look</span>
                                <span style="padding:0 10px;"><?php echo smarty_modifier_escape($_smarty_tpl->getVariable('product')->value->look,'htmlall','UTF-8');?>
</span>
                            </li>
                        <?php }?>
                    </ul>
                    ...
                    <ul>
                        <li>
                            <ul style="padding:5px 15px;">
                                <li>1. Avoid Contact with Water</li>
                                <li>2. Avoid perfume/deodorant sprays directly on it.</li>
                                <li>3. Store in Ziplock plastic or Butter paper after use.</li>
                                <li>4. Avoid storing in Velvet box.
                                <li>5. Wipe jewelry with a soft cotton cloth after every use.</li>
                            </ul>
                        </li>
                    </ul>
                </div>
                <div id="tabs5" class='etab_content' style="height:300px;">
                    <?php $_smarty_tpl->tpl_vars["nocust"] = new Smarty_variable("1", null, null);?>
