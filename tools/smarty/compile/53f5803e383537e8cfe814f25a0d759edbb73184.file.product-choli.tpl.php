<?php /* Smarty version Smarty-3.0.7, created on 2015-07-25 04:07:10
         compiled from "/var/www/html/indusdiva/themes/violettheme/product-choli.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18996690355b2be16a027a1-37033898%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '53f5803e383537e8cfe814f25a0d759edbb73184' => 
    array (
      0 => '/var/www/html/indusdiva/themes/violettheme/product-choli.tpl',
      1 => 1436974133,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18996690355b2be16a027a1-37033898',
  'function' => 
  array (
  ),
...
" id="product_page_product_id" />
                ...
                <input type="hidden" name="is_customized" id="is_customized" value="<?php echo $_smarty_tpl->getVariable('product')->value->is_customizable;?>
" />
...
″
 ...
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
                ...
                <?php }?>
                <?php if ($_smarty_tpl->getVariable('product')->value->is_customizable==1){?>
                        ...
                        <div id="designercholi-measure-select" style="padding: 5px 0px 5px 20px;vertical-align:top;" class="measure-select">
                            ...
                            <div style="width:250px;display:inline-block">
                                ...
                                <div id="designer_size_chart" style="display:none">
                                    <?php $_template = new Smarty_Internal_Template(($_smarty_tpl->getVariable('tpl_dir')->value)."/brandsizes/designer-choli.tpl", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="indiancholi-measure-select" style="padding: 5px 0px 5px 20px;vertical-align:top;display:none" class="measure-select">
                            ...
                            <div style="width:250px;display:inline-block">
                                ...
                                <div id="indian_size_chart" style="display:none">
                                    <?php $_template = new Smarty_Internal_Template(($_smarty_tpl->getVariable('tpl_dir')->value)."/brandsizes/indian-choli.tpl", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
                                </div>
                            </div>
                        </div>
                        ...
                        <p style="margin-bottom:3px;">
                            ...
                            <label for="c-corset-style">Corset Choli <span style="padding:0 15px;color:#E08323">+ <?php echo Product::convertAndShow(array('price'=>36),$_smarty_tpl);?>
</span></label>
                        <div id="corsetcholi-measure-select" style="padding: 5px 0px 5px 20px;vertical-align:top;display:none" class="measure-select">
                            ...
                            <div style="width:250px;display:inline-block">
                                ...
                                <div id="corset_size_chart" style="display:none">
                                    <?php $_template = new Smarty_Internal_Template(($_smarty_tpl->getVariable('tpl_dir')->value)."/brandsizes/corset-choli.tpl", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="custom_group" style="border-top:1px dashed #cacaca;border-bottom:1px dashed #cacaca;">
                        ...
                        <p style="margin-bottom:3px;">
                            ...
                            <label for="c-customization-longcholi">Long Choli (covering waist uptil the navel)<span style="padding:0 15px;color:#E08323">+ <?php echo Product::convertAndShow(array('price'=>9),$_smarty_tpl);?>
</span></label>
                        </p>
                        <p style="margin-bottom:3px;">
                            <input type="checkbox" name="c-customization-longsleeves" id="c-customization-longsleeves" value="1"/>
                            <label for="c-customization-longsleeves">Long Sleeves (3/4th sleeves)<span style="padding:0 15px;color:#E08323">+ <?php echo Product::convertAndShow(array('price'=>9),$_smarty_tpl);?>
</span></label>
                        </p>
                    </div>
                </div>
