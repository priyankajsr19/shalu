<?php /* Smarty version Smarty-3.0.7, created on 2015-08-16 17:35:16
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/indusdiva2/themes/violettheme/product-lehenga.tpl" */ ?>
<?php /*%%SmartyHeaderCode:470094955d07c7ce86821-18324759%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '75f96e59224c7238d9bbfbe9b78a5e0d89b0932f' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/indusdiva2/themes/violettheme/product-lehenga.tpl',
      1 => 1439565779,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '470094955d07c7ce86821-18324759',
  'function' => 
  array (
  ),
...
if (!is_callable('smarty_modifier_date_format')) include '/Applications/XAMPP/xamppfiles/htdocs/indusdiva2/tools/smarty/plugins/modifier.date_format.php';
...
';
        ...
        <?php if ($_smarty_tpl->getVariable('cookie')->value->isLogged()){?>
                                            $('#create_choli_measurement').trigger('click');
        <?php }else{ ?>
        ...
        <?php }?>
                            ...
                            {
        <?php if ($_smarty_tpl->getVariable('cookie')->value->isLogged()){?>
                                            $('#create_lehenga_measurement').trigger('click');
        <?php }else{ ?>
                                            $('.login_link').trigger('click');
        <?php }?>
                                        }
                                    ...
                                    $("input[name='lc-customization-option']").change(function() {
                                        if ($("input[name='lc-customization-option']:checked").val() == 2) {
                                            $('#lc-customizations').fadeIn('slow');
					    $(".cust_height").removeAttr("disabled");
					}
                                        else {
                                            $('#lc-customizations').fadeOut();
                                    ...
                                    var $radios = $("input[name='lc-customization-option']");
                                    ...
                                    $('#change-blouse-style').fancybox({
                                        ...
                                        afterShow: function() {
                                            ...
                                            $('.style-select').click(function() {
                                                ...
                                                $('#id_choli_style').val($(this).attr('rel'));
                                                $.fancybox.close();
                                            });
                                    ...
                                    $('#change-inskirt-style').fancybox({
                                        ...
                                        afterShow: function() {
                                            $('.style-select').click(function() {
                                                ...
                                                $('#id_lehenga_style').val($(this).attr('rel'));
                                                $.fancybox.close();
                                            });
                                        }
                                    });
        ...
        <?php if ($_smarty_tpl->getVariable('product')->value->is_customizable){?>
                                    $('#buy_block').submit(function(e) {
                                        var isCustomizationSelected = $("input[name='lc-customization-option']:checked").val() == 2 ? true : false;

                                        if (!isCustomizationSelected) {
                                            $('#prestitched_lc').val(0);
                                            return true;
                                        }

                                        $('#prestitched_lc').val(1);

                                        var choli_measurementID = $('#blouse_measurement_id option:selected').val();
                                        var lehenga_measurementID = $('#skirt_measurement_id option:selected').val();

                                        if (choli_measurementID)
                                            $('#id_choli_measurement').val(choli_measurementID);

                                        if (lehenga_measurementID)
                                            $('#id_lehenga_measurement').val(lehenga_measurementID);
                                        ...
                                        if (lehenga_measurementID < 1)
                                        {
                                            e.preventDefault();
                                            alert('Please select a lehenga measurement');
                                        }
...
" id="product_page_product_id" />
                            ...
                            <?php if ($_smarty_tpl->getVariable('product')->value->is_customizable){?>
                                ...
                                <input type="hidden" name="id_choli_measurement" id="id_choli_measurement" value="0" />
                                <input type="hidden" name="id_lehenga_measurement" id="id_lehenga_measurement" value="0" />
                                <?php if ((($tmp = @$_smarty_tpl->getVariable('as_shown')->value)===null||$tmp==='' ? false : $tmp)!=true){?>
                                    <input type="hidden" name="id_choli_style" id="id_choli_style" value="15" />
                                <?php }else{ ?>
                                    <input type="hidden" name="id_choli_style" id="id_choli_style" value="23" />
                                <?php }?>
                                <input type="hidden" name="id_lehenga_style" id="id_lehenga_style" value="0" />
                                <input type="hidden" name="prestitched_lc" id="prestitched_lc" value="0" />
...
<?php }else{ ?>1<?php }?><?php }?>" <?php if ($_smarty_tpl->getVariable('product')->value->minimal_quantity>1){?>onkeyup="checkMinimalQuantity(<?php echo $_smarty_tpl->getVariable('product')->value->minimal_quantity;?>
                        ...
                        <div id="customizations" style="margin-top:10px;">
 ...
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
                            ...
                            <?php if ($_smarty_tpl->getVariable('product')->value->is_customizable){?>
                                <div class="custom_group" style="border-top:1px dashed #cacaca;border-bottom:1px dashed #cacaca;">
                                    ...
                                    <?php $_smarty_tpl->tpl_vars['cust_display'] = new Smarty_variable('display:block;', null, null);?>
				                    <?php if ((($tmp = @$_smarty_tpl->getVariable('as_shown')->value)===null||$tmp==='' ? true : $tmp)!=true){?>
                                        <?php $_smarty_tpl->tpl_vars["checked"] = new Smarty_variable('', null, null);?>
                                        <?php $_smarty_tpl->tpl_vars["cust_display"] = new Smarty_variable("display:none", null, null);?>
                                        <p style="margin-bottom:3px;">
                                            <input type="radio" name="lc-customization-option" id="skd-fabric" value="1" checked/>
                                            <label for="skd-fabric">Pick just the fabric</label>
                                        </p>
                                    <?php }?>
                                    <p style="margin-bottom:3px;">
                                        <input type="radio" name="lc-customization-option" id="sc-pre-stitched-lc" value="2" <?php echo $_smarty_tpl->getVariable('checked')->value;?>
/>
                                        <label for="sc-pre-stitched-lc">Customize to your size <span style="padding:0 15px;color:#E08323">+ <?php echo Product::convertAndShow(array('price'=>25),$_smarty_tpl);?>
</span></label>
                                    </p>
                                    <div id="lc-customizations" style="<?php echo $_smarty_tpl->getVariable('cust_display')->value;?>
">
                                        <span style="font-family:Abel;font-size:15px;display:inline-block;width:450px;vertical-align:top;padding:0px 0px;">Choli Measurement:</span>
...
styles/1-small.png" height="60" width="75" style="display:block"/>
                                                    <span id="blouse-style-name" style="font-family:Abel;font-size:14px;display:block;width:100%;text-align:center;line-height:1em">Round</span>
...
modals.php?&modal=1&bs=1&lehenga=1">More Styles</a>
                                                <?php }else{ ?>
                                                    <img id="blouse-style-img" src="<?php echo $_smarty_tpl->getVariable('img_ps_dir')->value;?>
styles/0-small.png" height="80" style="display:block"/>
                                                <?php }?>

                                            </div>
                                        </div>
                                        <div id="choli-measure-select" style="padding: 5px 0px 5px 20px;width:270px;display:inline-block;vertical-align:top;">
                                            ...
                                            <div style="width:165px;display:inline-block">
                                                <select id="blouse_measurement_id" name="c_measurement_id" style="<?php if (!isset($_smarty_tpl->getVariable('measurement_info',null,true,false)->value)){?>display:none<?php }else{ ?>display:inline<?php }?>;width:150px;padding:0;">
...
<?php if ($_smarty_tpl->tpl_vars['measurement']->value['is_std']==1){?>″<?php }?>
                                        ...
                                        <?php }?>
                                        <a id="create_choli_measurement" class="measure_link span_link fancybox.ajax" style="color:#75B1DC;display:block" href="<?php echo $_smarty_tpl->getVariable('base_dir')->value;?>
measurement.php?&modal=1&m=1&type=1">size chart</a>
                                    </div>
                                </div>
                                <div style="border-bottom:1px dashed #cacaca;margin:5px 0"></div>
                                <span style="font-family:Abel;font-size:15px;display:inline-block;width:450px;vertical-align:top;padding:0px 0px;">Lehenga Measurement:</span>
                                <div id="skirt-style-select" style="padding: 5px 20px 5px 0px;width:150px;display:inline-block;border-right:1px solid #cacaca">
                                    <span style="font-family:Abel;font-size:15px;display:inline-block;width:50px;height:60px;vertical-align:top;padding:0px 10px;">1. Style:</span>
...
styles/0-small.png" height="80"/>
                                        <?php if ((($tmp = @$_smarty_tpl->getVariable('as_shown')->value)===null||$tmp==='' ? false : $tmp)!=true){?>
                                            <span id="inskirt-style-name" style="font-family:Abel;font-size:14px;display:block;width:100%;line-height:1em">As Shown</span>
...
modals.php?&modal=1&iss=1&lehenga=1">More Styles</a>
                                        <?php }?>
                                    </div>
                                </div>
                                <div id="lehenga-measure-select" style="padding: 5px 0px 5px 20px;width:270px;display:inline-block;vertical-align:top;">
                                    <div style="display:inline-block">
                                        <span style="font-family:Abel;font-size:15px;display:inline-block;width:100px;height:60px;vertical-align:top;padding:0px 0px;">2. Measurement:</span>
                                        <div style="width:165px;display:inline-block">
                                            <select id="skirt_measurement_id" name="l_measurement_id" style="<?php if (!isset($_smarty_tpl->getVariable('skirt_measurement_info',null,true,false)->value)){?>display:none<?php }else{ ?>display:inline<?php }?>;width:150px;padding:0;">
                                                <option value="0" selected>Select a measurement</option>
        ...
        <div id="more_info_block">
            ...
            <div id="tab-container" class="tab-container" style="height:300px;">
                ...
                <div id="tabs1" class='etab_content' style="height:300px;overflow:auto;-ms-overflow-x: hidden;overflow-x: hidden;">
                    ...
                    <?php if ($_smarty_tpl->getVariable('product')->value->is_customizable){?>
                        <?php if ((($tmp = @$_smarty_tpl->getVariable('as_shown')->value)===null||$tmp==='' ? false : $tmp)!=true){?>
                            <p>You can choose the desired design for your Lehenga and Choli, we will try our best to customize it to your taste but in certain select cases the fabric may be suitable to be stitched only as per the design and pattern displayed in the visual. Our Designer will take the final call and the same will be communicated.</p>
                        <?php }else{ ?>
                            <p>This outfit is suitable to be customized only as per the design and pattern displayed in the visual.</p>
                        <?php }?>
                    <?php }?>
                </div>
                <div id="tabs2" class='etab_content' style="height:300px;">
                    <ul>
                        ...
                        <?php }?>
                        <?php if (isset($_smarty_tpl->getVariable('product',null,true,false)->value->skirt_length)&&$_smarty_tpl->getVariable('product')->value->skirt_length){?>
                            <li>
                                <span style="font-weight:bold;display:inline-block;width:90px;">Lehenga Length</span>
                                <span style="padding:0 10px;"><?php echo smarty_modifier_escape($_smarty_tpl->getVariable('product')->value->skirt_length,'htmlall','UTF-8');?>
 inches</span>
                            </li>
                        <?php }?>
                        <?php if (isset($_smarty_tpl->getVariable('product',null,true,false)->value->dupatta_length)&&$_smarty_tpl->getVariable('product')->value->dupatta_length){?>
                            <li>
                                <span style="font-weight:bold;display:inline-block;width:90px;">Dupatta Length</span>
                                <span style="padding:0 10px;"><?php echo smarty_modifier_escape($_smarty_tpl->getVariable('product')->value->dupatta_length,'htmlall','UTF-8');?>
 meters</span>
                            </li>
                        <?php }?>
                    </ul>
