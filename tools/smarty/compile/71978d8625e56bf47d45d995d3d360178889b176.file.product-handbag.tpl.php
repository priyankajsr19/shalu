<?php /* Smarty version Smarty-3.0.7, created on 2015-06-05 03:13:35
         compiled from "/var/www/html/indusdiva/themes/violettheme/product-handbag.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3166664495570c68714e348-76299726%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '71978d8625e56bf47d45d995d3d360178889b176' => 
    array (
      0 => '/var/www/html/indusdiva/themes/violettheme/product-handbag.tpl',
      1 => 1431660623,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3166664495570c68714e348-76299726',
  'function' => 
  array (
  ),
...
″
                                                <?php }elseif($_smarty_tpl->getVariable('is_abaya')->value){?>
            ...
            <div id="tab-container" class="tab-container">
                ...
                <div id="tabs2" class='etab_content' style="height:300px;">
                    <ul>
                        ...
                        <?php }?>
                        <?php if (isset($_smarty_tpl->getVariable('product',null,true,false)->value->handbag_occasion)&&$_smarty_tpl->getVariable('product')->value->handbag_occasion!=''){?>
                            <li>
                                <span style="font-weight:bold;display:inline-block;width:90px;">Occasion:</span>
                                <span style="padding:0 10px;"><?php echo smarty_modifier_escape($_smarty_tpl->getVariable('product')->value->handbag_occasion,'htmlall','UTF-8');?>
</span>
                            </li>
                        <?php }?>
                        <?php if (isset($_smarty_tpl->getVariable('product',null,true,false)->value->handbag_style)&&$_smarty_tpl->getVariable('product')->value->handbag_style){?>
                            <li>
                                <span style="font-weight:bold;display:inline-block;width:90px;">Style:</span>
                                <span style="padding:0 10px;"><?php echo smarty_modifier_escape($_smarty_tpl->getVariable('product')->value->handbag_style,'htmlall','UTF-8');?>
</span>
                            </li>
                        <?php }?>
                        <?php if (isset($_smarty_tpl->getVariable('product',null,true,false)->value->handbag_material)&&$_smarty_tpl->getVariable('product')->value->handbag_material){?>
                            <li>
                                <span style="font-weight:bold;display:inline-block;width:90px;">Material:</span>
                                <span style="padding:0 10px;"><?php echo smarty_modifier_escape($_smarty_tpl->getVariable('product')->value->handbag_material,'htmlall','UTF-8');?>
</span>
                            </li>
                        <?php }?>
