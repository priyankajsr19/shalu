<?php /* Smarty version Smarty-3.0.7, created on 2015-07-23 04:43:46
         compiled from "/var/www/html/indusdiva/themes/violettheme/shopping-cart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:61379451755b023aa571ca3-71416402%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'afcfa196660a91a777463a580b87e41b9f01b388' => 
    array (
      0 => '/var/www/html/indusdiva/themes/violettheme/shopping-cart.tpl',
      1 => 1437397518,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '61379451755b023aa571ca3-71416402',
  'function' => 
  array (
  ),
...
<?php }?><?php echo smartyTranslate(array('s'=>':'),$_smarty_tpl);?>
                                    ...
                                    <td class="price" id="total_product">
                                        <?php echo Tools::displayPriceSmarty(array('price'=>$_smarty_tpl->getVariable('total_products')->value),$_smarty_tpl);?>
...
<?php echo smartyTranslate(array('s'=>':'),$_smarty_tpl);?>
                                    ...
                                    <?php if (isset($_smarty_tpl->getVariable('customization',null,true,false)->value)&&$_smarty_tpl->getVariable('customization')->value>0){?>
                                        <td class="price" id="total_product">
                                            <?php echo Tools::displayPriceSmarty(array('price'=>($_smarty_tpl->getVariable('total_products_wt')->value-$_smarty_tpl->getVariable('customization')->value)),$_smarty_tpl);?>
</td>
                                    <?php }else{ ?>
                                        <td class="price" id="total_product">
                        ...
                        <tr class="cart_total_voucher" <?php if ($_smarty_tpl->getVariable('total_discounts')->value==0){?> style="display: none;"<?php }?>>
                            <td colspan="5">
                                <?php if ($_smarty_tpl->getVariable('use_taxes')->value){?> <?php if ($_smarty_tpl->getVariable('priceDisplay')->value){?> <?php echo smartyTranslate(array('s'=>'Total vouchers/discounts'),$_smarty_tpl);?>
<?php if ($_smarty_tpl->getVariable('display_tax_label')->value){?> <?php echo smartyTranslate(array('s'=>'(tax excl.)'),$_smarty_tpl);?>
<?php }?><?php echo smartyTranslate(array('s'=>':'),$_smarty_tpl);?>
...
<?php }?><?php echo smartyTranslate(array('s'=>':'),$_smarty_tpl);?>
 ...
 <?php }?>
                            ...
                            <td class="price-discount" id="total_discount">
                                <?php if ($_smarty_tpl->getVariable('use_taxes')->value){?> <?php if ($_smarty_tpl->getVariable('priceDisplay')->value){?> <?php echo Tools::displayPriceSmarty(array('price'=>$_smarty_tpl->getVariable('total_discounts_tax_exc')->value),$_smarty_tpl);?>
 ...
 <?php }?>
                        ...
                        <tr class="cart_total_voucher" <?php if ($_smarty_tpl->getVariable('total_wrapping')->value==0){?> style="display: none;"<?php }?> >
                            <td colspan="5">
                                <?php if ($_smarty_tpl->getVariable('use_taxes')->value){?> <?php if ($_smarty_tpl->getVariable('priceDisplay')->value){?> <?php echo smartyTranslate(array('s'=>'Total gift-wrapping'),$_smarty_tpl);?>
<?php if ($_smarty_tpl->getVariable('display_tax_label')->value){?> <?php echo smartyTranslate(array('s'=>'(tax excl.)'),$_smarty_tpl);?>
<?php }?><?php echo smartyTranslate(array('s'=>':'),$_smarty_tpl);?>
...
<?php }?><?php echo smartyTranslate(array('s'=>':'),$_smarty_tpl);?>
 ...
 <?php }?></td>
                            <td class="price-discount" id="total_wrapping">
                                <?php if ($_smarty_tpl->getVariable('use_taxes')->value){?> <?php if ($_smarty_tpl->getVariable('priceDisplay')->value){?> <?php echo Tools::displayPriceSmarty(array('price'=>$_smarty_tpl->getVariable('total_wrapping_tax_exc')->value),$_smarty_tpl);?>
