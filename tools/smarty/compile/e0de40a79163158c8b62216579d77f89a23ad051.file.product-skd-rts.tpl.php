<?php /* Smarty version Smarty-3.0.7, created on 2015-07-25 08:51:10
         compiled from "/var/www/html/indusdiva/themes/violettheme/product-skd-rts.tpl" */ ?>
<?php /*%%SmartyHeaderCode:22490044155b300a69f9e69-31371292%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e0de40a79163158c8b62216579d77f89a23ad051' => 
    array (
      0 => '/var/www/html/indusdiva/themes/violettheme/product-skd-rts.tpl',
      1 => 1436974022,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '22490044155b300a69f9e69-31371292',
  'function' => 
  array (
  ),
        ...
        $(document).ready(function() {
            ...
            $("input[name='skd-customization-option']").change(function() {
                if ($("input[name='skd-customization-option']:checked").val() == 2) {
                    ...
                    $(".cust_height").removeAttr("disabled");
                }
                else {
                    $('#skd-customizations').fadeOut();
                    $(".cust_height").attr("disabled","disabled");
                }
            });
            ...
            $('#change-kurta-style' ).fancybox({
                ...
                afterShow: function() {
                    ...
                    $('.style-select').click(function() {
                        $('#kurta-style-img').attr('src', $(this).attr('data-image'));
                        $('#kurta-style-name').html($(this).find('.style-name').html());
                        $('#id_kurta_style').val($(this).attr('rel'));
                        $.fancybox.close();
                    });
            ...
            $('#change-salwar-style' ).fancybox({
                ...
                afterShow: function() {
                    ...
                    $('.style-select').click(function() {
                        $('#salwar-style-img').attr('src', $(this).attr('data-image'));
                        $('#salwar-style-name').html($(this).find('.style-name').html());
                        $('#id_salwar_style').val($(this).attr('rel'));
            ...
            <?php if ($_smarty_tpl->getVariable('product')->value->is_customizable){?>
                $('#buy_block').submit(function(e) {
                    ...
                    var ht_ft = $("#cust_height_ft").val();
                    var ht_in = $("#cust_height_in").val();
                    if( ht_ft < 0 || ht_in < 0 ) {
                        e.preventDefault();
...
, <?php echo $_smarty_tpl->tpl_vars['combination']->value['minimal_quantity'];?>
            ...
            <?php if (count($_smarty_tpl->getVariable('colors')->value)>0){?>
                <?php if ($_smarty_tpl->getVariable('product')->value->id_color_default){?>
                    var id_color_default = <?php echo intval($_smarty_tpl->getVariable('product')->value->id_color_default);?>
;
                <?php }?>
            <?php }?>
        <?php }?>
...
" href="javascript:{}"><?php echo smartyTranslate(array('s'=>'Next'),$_smarty_tpl);?>
                    ...
                    <?php }?>
                    <?php if (isset($_smarty_tpl->getVariable('images',null,true,false)->value)&&count($_smarty_tpl->getVariable('images')->value)>1){?>
...
" width="16" height="18"/>
                                <a id="resetImages" href="<?php echo $_smarty_tpl->getVariable('link')->value->getProductLink($_smarty_tpl->getVariable('product')->value);?>
...
" id="product_page_product_id" />
				...
				<?php if (isset($_smarty_tpl->getVariable('kurta_style',null,true,false)->value)&&!empty($_smarty_tpl->getVariable('kurta_style',null,true,false)->value)){?>
	                                <input type="hidden" name="id_kurta_style" id="id_kurta_style" value="<?php echo $_smarty_tpl->getVariable('kurta_style')->value['id_style'];?>
" />
                                	<input type="hidden" name="id_kurta_measurement" id="id_kurta_measurement" value="0" />
				<?php }else{ ?>
	                                <input type="hidden" name="id_kurta_style" id="id_kurta_style" value="NA" />
                                	<input type="hidden" name="id_kurta_measurement" id="id_kurta_measurement" value="NA" />
				<?php }?>
				<?php if (isset($_smarty_tpl->getVariable('salwar_style',null,true,false)->value)&&!empty($_smarty_tpl->getVariable('salwar_style',null,true,false)->value)){?>
	                                <input type="hidden" name="id_salwar_style" id="id_salwar_style" value="<?php echo $_smarty_tpl->getVariable('salwar_style')->value['id_style'];?>
" />
                                	<input type="hidden" name="id_salwar_measurement" id="id_salwar_measurement" value="0" />
				<?php }else{ ?>
	                                <input type="hidden" name="id_salwar_style" id="id_salwar_style" value="NA" />
                                	<input type="hidden" name="id_salwar_measurement" id="id_salwar_measurement" value="NA" />
				<?php }?>
...
">
                                                            <?php if ($_smarty_tpl->getVariable('is_bottoms')->value){?>
                                                                Waist: <?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['group_attribute']->value,'htmlall','UTF-8');?>
″
                                                            <?php }else{ ?>
                                                                Bust: <?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['group_attribute']->value,'htmlall','UTF-8');?>
″
                                                            <?php }?>
                                                        </option>
                                                    <?php }} ?>
                            ...
                            <?php if ($_smarty_tpl->getVariable('product')->value->is_customizable){?>
                                <div class="custom_group" style="border-top:1px dashed #cacaca;border-bottom:1px dashed #cacaca;">
                                    ...
                                    <p style="margin-bottom:3px;">
                                        ...
                                        <label for="sc-pre-stitched-skd">
                                            Customize to your size 
                                            <?php if (($_smarty_tpl->getVariable('kurta_style_count')->value<=0)||($_smarty_tpl->getVariable('salwar_style_count')->value<=0)){?>
                                                <span style="padding:0 15px;color:#E08323">+ <?php echo Product::convertAndShow(array('price'=>5),$_smarty_tpl);?>
</span>
                                            <?php }else{ ?>  
                                                <?php if (isset($_smarty_tpl->getVariable('is_anarkali',null,true,false)->value)&&$_smarty_tpl->getVariable('is_anarkali')->value){?>
                                                    <span style="padding:0 15px;color:#E08323">+ <?php echo Product::convertAndShow(array('price'=>14),$_smarty_tpl);?>
</span>
                                                <?php }else{ ?>
                                                    <span style="padding:0 15px;color:#E08323">+ <?php echo Product::convertAndShow(array('price'=>9),$_smarty_tpl);?>
</span>
                                                <?php }?>
                                            <?php }?>
                                        </label>
                                    </p>
                                    <?php $_smarty_tpl->tpl_vars['incr'] = new Smarty_variable(0, null, null);?>
                                    <div id="skd-customizations" style="display:none">
                                        <?php if ($_smarty_tpl->getVariable('kurta_style_count')->value>0){?>
                                            <?php $_smarty_tpl->tpl_vars['incr'] = new Smarty_variable($_smarty_tpl->getVariable('incr')->value+1, null, null);?>
                                            <div class="clearfix" style="padding:6px 0px 6px 10px">
                                                <span style="font-family:Abel;font-size:15px;display:block;">
                                                    <?php if (isset($_smarty_tpl->getVariable('is_pakistani_rts',null,true,false)->value)&&!empty($_smarty_tpl->getVariable('is_pakistani_rts',null,true,false)->value)){?>
                                                        <?php echo $_smarty_tpl->getVariable('incr')->value;?>
. Neckline and Kurta Cut is as shown in the product visual
                                                    <?php }else{ ?>
                                                        <?php echo $_smarty_tpl->getVariable('incr')->value;?>
. Kurta Cut is as shown in the product visual
                                                    <?php }?>
                                                </span>
                                            </div>    
                                            <?php $_smarty_tpl->tpl_vars['incr'] = new Smarty_variable($_smarty_tpl->getVariable('incr')->value+1, null, null);?>
                                            <div class="clearfix" style="padding:6px 0px 6px 0px">
                                                <div id="kurta-style-select" style="float:left;padding: 5px 20px 5px 0px;width:150px;display:inline-block;border-right:1px solid #cacaca">
                                                    <span style="font-family:Abel;font-size:15px;display:block;vertical-align:top;padding:0px 10px;"><?php echo $_smarty_tpl->getVariable('incr')->value;?>
. Top style:</span>
                                                    <div style="width:75px;display:inline-block;padding: 5px 0px 0px 20px;">
                                                        <img id="kurta-style-img" src="<?php echo $_smarty_tpl->getVariable('img_ps_dir')->value;?>
styles/<?php echo $_smarty_tpl->getVariable('kurta_style')->value['style_image_small'];?>
" height="60" width="75" style="display:block"/>
                                                        <span id="kurta-style-name" style="font-family:Abel;font-size:14px;display:block;width:100%;text-align:center;line-height:1em"><?php echo $_smarty_tpl->getVariable('kurta_style')->value['style_name'];?>
</span>
                                                        <?php if ($_smarty_tpl->getVariable('kurta_style_count')->value>1){?>
                                                            <a id="change-kurta-style" class="fancybox.ajax" style="font-size:12px;display:block;width:100%;text-align:center;line-height:13px;color:#75B1DC;" href="<?php echo $_smarty_tpl->getVariable('base_dir')->value;?>
modals.php?&modal=1&id=<?php echo $_smarty_tpl->getVariable('product')->value->id;?>
&sts=1">More Styles</a>
                                                        <?php }?>
                                                    </div>
                                                </div>
                                                <div id="kurta-measure-select" style="float:right;padding: 5px 20px 5px 20px;width:245px;display:inline-block;">
                                                    <span style="font-family:Abel;font-size:15px;display:block;width:150px;vertical-align:top;padding:0px 0px;"><?php echo $_smarty_tpl->getVariable('incr')->value;?>
. Kurta Measurement:</span>
                                                    <div style="width:165px;display:inline-block;padding-top: 10px;">
...
measurement.php?&modal=1&m=1&type=3">size chart</a>
                                        ...
                                        <?php }?> 
                                        <?php if ($_smarty_tpl->getVariable('salwar_style_count')->value>0){?>
                                            <?php $_smarty_tpl->tpl_vars['incr'] = new Smarty_variable($_smarty_tpl->getVariable('incr')->value+1, null, null);?>
                                            <div class="clearfix" style="padding:6px 0px 6px 0px">
                                            
                                                <div id="salwar-style-select" style="float:left;padding: 5px 20px 5px 0px;width:150px;display:inline-block;border-right:1px solid #cacaca">
                                                    <span style="font-family:Abel;font-size:15px;display:block;vertical-align:top;padding:0px 10px;"><?php echo $_smarty_tpl->getVariable('incr')->value;?>
. Bottom style:</span>
                                                    <div style="width:75px;display:inline-block;padding: 5px 0px 0px 20px;">
                                                        <img id="salwar-style-img" src="<?php echo $_smarty_tpl->getVariable('img_ps_dir')->value;?>
styles/<?php echo $_smarty_tpl->getVariable('salwar_style')->value['style_image_small'];?>
" height="60" width="75" style="display:block"/>
                                                        <span id="salwar-style-name" style="font-family:Abel;font-size:14px;display:block;width:100%;text-align:center;line-height:1em"><?php echo $_smarty_tpl->getVariable('salwar_style')->value['style_name'];?>
</span>
                                                        <?php if ($_smarty_tpl->getVariable('salwar_style_count')->value>1){?>
                                                            <a id="change-salwar-style" class="fancybox.ajax" style="font-size:12px;display:block;width:100%;text-align:center;line-height:13px;color:#75B1DC;" href="<?php echo $_smarty_tpl->getVariable('base_dir')->value;?>
modals.php?&modal=1&id=<?php echo $_smarty_tpl->getVariable('product')->value->id;?>
&sbs=1">More Styles</a>
                                                        <?php }?>
                                                    </div>
                                                </div>
                                                <div id="salwar-measure-select" style="float:right; padding: 5px 0px 5px 20px;width:265px;display:inline-block;vertical-align:top;">
                                                    <span style="font-family:Abel;font-size:15px;display:block;width:150px;vertical-align:top;padding:0px 0px;"><?php echo $_smarty_tpl->getVariable('incr')->value;?>
. Bottom Measurement:</span>
...
measurement.php?&modal=1&m=1&type=4">size chart</a>
                                        ...
                                        <?php }?>
                                        <?php $_template = new Smarty_Internal_Template(($_smarty_tpl->getVariable('tpl_dir')->value)."/customization_customer_height.tpl", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
                                    </div>
                                </div>
                            <?php }?>
...
" />
                    ...
                    <?php }?>
                <?php }?>
                <?php if ($_smarty_tpl->getVariable('HOOK_EXTRA_RIGHT')->value){?>
                    <?php echo $_smarty_tpl->getVariable('HOOK_EXTRA_RIGHT')->value;?>
                ...
                <div id="more_info_block">
                    ...
                    <div id="tab-container" class="tab-container">
                        ...
                        <div id="tabs1" class='etab_content' style="height:300px;overflow:auto;-ms-overflow-x: hidden;overflow-x: hidden;">
                            ...
                            <?php }?>
                            <p>This ready to made outfit can be customized to a bust size of 42" (comfort fit).  In case you need any size bigger, the same may be possible wherein we shall attach a fabric of matching color to stitch the garment. While this is done aesthetically by our Design Studio in a way that it’s not very visible, a slight color and texture variation is possible.</p>
                        </div>
 ...
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
        ...
        <p style="clear:both;border-bottom: 1px dashed #CACACA;padding:5px 0">
            *There may be minor color variations because of the light and settings during photography and also the color settings and properties of various monitors.
        </p>
