<?php /* Smarty version Smarty-3.0.7, created on 2015-08-16 17:58:59
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/indusdiva2/themes/violettheme/modules/blockcart/blockcart-json.tpl" */ ?>
<?php /*%%SmartyHeaderCode:127086936355d0820b26d058-01278835%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3662aa27f8a509d4f072bd5c900a274622317441' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/indusdiva2/themes/violettheme/modules/blockcart/blockcart-json.tpl',
      1 => 1437833324,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '127086936355d0820b26d058-01278835',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
)); /*/%%SmartyHeaderCode%%*/?>
<?php if (!is_callable('smarty_modifier_replace')) include '/Applications/XAMPP/xamppfiles/htdocs/indusdiva2/tools/smarty/plugins/modifier.replace.php';
if (!is_callable('smarty_modifier_escape')) include '/Applications/XAMPP/xamppfiles/htdocs/indusdiva2/tools/smarty/plugins/modifier.escape.php';
?>
...
<?php echo html_entity_decode(ob_get_clean(),2,'UTF-8')?><?php }?>",
		"name":          "<?php echo smarty_modifier_truncate(smarty_modifier_escape(html_entity_decode($_smarty_tpl->tpl_vars['product']->value['name'],2,'UTF-8')),100,'...',true);?>
",
...
",
"totalDiscounts": "<?php echo html_entity_decode($_smarty_tpl->getVariable('totalDiscounts')->value,2,'UTF-8');?>
",
"productTotal": "<?php echo html_entity_decode($_smarty_tpl->getVariable('product_total')->value,2,'UTF-8');?>
",
"only_products": "<?php echo html_entity_decode($_smarty_tpl->getVariable('ajax_products_total')->value,2,'UTF-8');?>
",
