...
*** '.$this->l('Quick Checkout Moneybookers').'
	...
	public function hookPayment($params)
	{
		...
		else
		{
			...
			$mbParams['cancel_url'] = (Configuration::get('PS_SSL_ENABLED') ? 'https' : 'http').'://'.$_SERVER['HTTP_HOST'].__PS_BASE_URI__.'modules/'.$this->name.'/failure.php';			
			...
			$mbParams['amount'] = number_format($params['cart']->getOrderTotal(), 0, '.', '');
