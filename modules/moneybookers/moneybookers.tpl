{if $display_mode == 0}
<p id="pay-payu" class="payment_module">
    <input type="radio" name="payMethod" value="mb" style="margin-left:30px;font-size:15px;" checked="checked"/>
    Credit Card/ Debit Card/ NetBanking
</p>
	<form id="mb-form" action="https://www.moneybookers.com/app/payment.pl" method="post">
	<p class="payment_module" style="display: none;">
		...
		<input type="hidden" class="payment_methods" name="payment_methods" value="AMX,DIN,MAE,MSC,VSA">
