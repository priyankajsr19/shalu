...
class BlockCart extends Module
{
	...
	public function smartyAssigns(&$smarty, &$params)
	{
		...
		$smarty->assign(array(
		    ...
		    'totalDiscounts' => Tools::displayPrice(round($params['cart']->getOrderTotal($useTax, Cart::ONLY_DISCOUNTS)), $currency),
		    'ajax_products_total' => Tools::displayPrice($params['cart']->getOrderTotal($useTax, Cart::ONLY_PRODUCTS_WITHOUT_SHIPPING), $currency),
