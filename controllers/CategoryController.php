...
class CategoryControllerCore extends FrontController
{
	...
	public function displayHeader()
	{
		...
		self::$smarty->assign('paginationBaseUrl', $rewrited_url);
		...
		else
		{
			...
			else
			{
				...
				if ($this->category->id != 1)
				{
					...
					//$this->pagination((int)$nbProducts);
					//self::$smarty->assign('nb_products', (int)$nbProducts);
					$cat_products = $this->cat_page_products;
				}
				self::$smarty->assign(array(
			...
			/*switch((int)($this->category->id))
			{
				case 2:
					$remarketing_code = "vTBWCOiyxwMQmKP4zQM";
					break;
			}
